(defproject ednonlineeditor "0.1.0-SNAPSHOT"
  ...
  :cljsbuild{:builds
              [{:id "dev"
                ...
                :figwheel {:on-jsload "ednonlineeditor.core/on-js-reload"}
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/ednonlineeditor.js"
                           :main ednonlineeditor.core
